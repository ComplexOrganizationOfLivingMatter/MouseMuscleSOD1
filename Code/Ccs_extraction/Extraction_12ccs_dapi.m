...
[data_cells_nuclei,data_cells_water,data_intercellular_space]=calculate_data_dapi(folder,name);
...
stringres=strcat('..\..\Processed_images\',folder,'\',name,'\Data_image\', 'Results_dapi_12_cc.mat');
