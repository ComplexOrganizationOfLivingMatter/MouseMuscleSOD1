function [data_cells_nuclei,data_cells_water,data_intercellular_space]=calculate_data_dapi(folder,name)
    ...
    cd ..\Segmentation
    [BWmax,BWmin]=Segmentation_dapi(folder,name);
    cd ..\Ccs_extraction
    ...
    save([path_data '\Data_image\Data_channel_blue.mat'],'L','L_mask_nuclei_peaks','L_mask_improved','L_intercellular_space_assigned','centroids','data_cells_nuclei','data_cells_water','data_intercellular_space')
