...
m2={matrixCONT80,matrixCONT100,matrixCONT120,matrixCONT100,matrixCONT120,matrixCONT120,matrixG93A80,matrixG93A100,matrixG93A100,matrixWT100,matrixWT120,matrixWT120,matrixG93A60,matrixG93A80,matrixCONT80,matrixG93A80,matrixG93A100,matrixCONT100,matrixG93A100,matrixCONT120};
...
m3={matrixG93A130,matrixG93A130,matrixG93A130,matrixG93A130,matrixG93A130};
...
for i=1:length(m1)
    matrix1=vertcat(cell2mat(m1{i}(:,2)));
    matrix2=vertcat(cell2mat(m2{i}(:,2)));
    matrix3=vertcat(cell2mat(m3{i}(:,2)));
    
    if strfind([name1{i},name2{i}],'60')>0
        %PCA_2_cc_Original(matrix1, matrix2, matrix3, 'Class1', 'Class2');
        PCA_2_cc_Original_G93A130(matrix1(indexesM1{i},1:69),matrix2(indexesM2{i},1:69),matrix3(indexesM3{i},1:69),name1{i},name2{i},path2save);
    else
        PCA_2_cc_Original_G93A130(matrix1(indexesM1{i},:),matrix2(indexesM2{i},:),matrix3(indexesM3{i},:),name1{i},name2{i},path2save);
    end
end
